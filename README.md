...
<p align="center">
  ...
  <a href="packages/cli/README.md#get-started"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/badge/Platform-macOS%20%7C%20Linux%20%7C%20Windows.svg?variant=outline&size=xs&mode=dark"><img src="https://shieldcn.dev/badge/Platform-macOS%20%7C%20Linux%20%7C%20Windows.svg?variant=outline&size=xs&mode=light" alt="Platform: macOS, Linux, Windows"></picture></a>
...
The CLI is in development and has not been published to npm. Native builds target macOS and Linux on arm64/x64, plus Windows x64. Building requires Node.js 24, pnpm, and a native toolchain. See the CLI guide for platform setup.
